...
c      PARAMETER (max_npart_tile = 256000)
c      PARAMETER (max_npart_exch =  64000)
      PARAMETER (max_npart_tile =2048000)
      PARAMETER (max_npart_exch = 512000)
c      PARAMETER (fltBufDim = (9+4*Nr))
      PARAMETER (fltBufDim = 14 )
